...
?>
    <style>
        ...
        .table-card h2 { font-size: 16px; font-weight: 700; color: #1515b5; margin-bottom: 16px; }
        table { width: 100%; border-collapse: collapse; }
        th { font-size: 12px; font-weight: 600; color: #6c757d; text-transform: uppercase; padding: 10px 12px; border-bottom: 2px solid #f0f0ff; }
        td { font-size: 14px; padding: 12px; border-bottom: 1px solid #f0f0ff; }
...
<?php require 'app/views/layouts/sidebar.php'; ?>
    ...
    <div class="main-content">
        <div class="page-header">
            ...
            <p>Gérez vos contributions à la newsletter</p>
        </div>
